...
import { H6, Paragraph } from '@/components/mui/typography'
import CartCheck from '@/components/icons/cart-check'
import TruckFast from '@/components/icons/truck-fast'
import CartX from '@/components/icons/cart-x'
  ...
  return (
    <ListItemWrapper p={2} gap={2} alignItems='center'>
      ...
      <Box>
        ...
        <Paragraph fontSize={11}>{formatDistance(createdAt, new Date(), { addSuffix: true })}</Paragraph>
      </Box>
    </ListItemWrapper>
  )
}
