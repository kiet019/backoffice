...
import { Paragraph, Span } from '@/components/mui/typography'
...
const BulletIcon = styled('div')<Active>(({ theme, active }) => ({
  ...
  boxShadow: active ? `0px 0px 0px 4px ${alpha(theme.palette.info.light, 0.2)}` : 'none'
}))
...
const ChevronRightIcon = styled(ChevronRight)<CollapseCompact>(({ collapsed, compact, theme: { direction } }) => ({
  fontSize: 18,
  color: 'white',
