...
export default function ViewDate({ dateValue, handleChangeDateValue, error, setError }: {
    ...
    return (
        <FormControl fullWidth id={id}>
            <FlexBetween
                sx={{
                    border: error || (dateValue?.[0] !== null && dateValue?.[1] === null) || (dateValue?.[1] !== null && dateValue?.[0] === null) ? "2px solid #D23F2F !important" : "1px solid rgba(0, 0, 0, 0.23)",
                ...
                <MultiInputDateRangeField
                    onError={(error) => {
                        if (error[0] === "invalidRange" && dateValue !== undefined) {
