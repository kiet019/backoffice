...
export const orderDetail: OrderDetail = {
    ...
    tag: [{ id: 1, name: "VAT" }, { id: 2, name: "Nhanh" }],
    place: { id: 1, name: "SG" },
    company: "fado168",
    ...
    orderItemList: [
        {
            ...
            product: {
                link: {
                    ...
                    origin: "https://www.farfetch.com/uk/shopping/women/burberry-mini-horseferry-print-leather-and-canvas-title-bag-item-14131666.aspx",
                },
